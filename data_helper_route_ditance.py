...
def main():
    ...
    core = 1 # 多開的數量
    data_path = 'output/2_distance_table_half.csv'
    tor_path = 'sub_project/path_planing/tor-win32-0.4.5.8/Tor/tor.exe' # 去這裡載 Tor Source -> https://www.torproject.org/download/tor/
    tor_confs_path = 'output/tor_confs'
